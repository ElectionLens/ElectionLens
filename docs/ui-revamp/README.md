...
- **`tnmla.in` was never analysed** — blocked by the corporate web gateway. Every
  measurement in §2b comes from a single benchmark. See the gap note in
  [§2b](./02b-card-visual-spec.md).
